...
const S: Record<string, React.CSSProperties> = {
  ...
  header: { display:"flex", justifyContent:"space-between", alignItems:"center", padding:"8px 16px", borderBottom:"1px solid var(--border)", backgroundColor:"var(--header-bg)", flexShrink:0, gap:12 },
  headerLeft: { display:"flex", alignItems:"center", gap:12 },
  headerCenter: { display:"flex", alignItems:"center", flex:1, justifyContent:"center", gap:8 },
  ...
  participantCount: { fontSize:13, color:"var(--text-secondary)" },
  nameDisplay: { padding:"2px 10px", borderRadius:6, border:"1px solid transparent", fontSize:14, fontWeight:600, color:"var(--text-primary)", cursor:"pointer", fontFamily:"inherit", background:"transparent" },
  nameInput: { padding:"2px 10px", borderRadius:6, border:"1px solid #6366F1", fontSize:14, fontWeight:600, color:"var(--text-primary)", outline:"none", fontFamily:"inherit", width:180, textAlign:"center" as const },
  hostBadge: { padding:"4px 10px", borderRadius:6, backgroundColor:"#FEF3C7", fontSize:12, fontWeight:600, color:"#92400E" },
  shareButton: { padding:"6px 14px", borderRadius:8, backgroundColor:"#F3F4F6", border:"1px solid var(--border)", fontSize:13, fontWeight:500, cursor:"pointer", color:"var(--text-secondary)", fontFamily:"inherit" },
  mainArea: { display:"flex", flex:1, overflow:"hidden" },
  canvas: { flex:1, overflow:"hidden" },
  participantSidebar: { width:200, flexShrink:0, borderRight:"1px solid var(--border)", backgroundColor:"var(--sidebar-bg)", padding:"12px 0", overflowY:"auto" },
  participantSidebarTitle: { fontSize:11, fontWeight:600, color:"var(--text-muted)", textTransform:"uppercase" as const, letterSpacing:1, padding:"0 14px 8px" },
  participantRow: { display:"flex", alignItems:"center", gap:8, padding:"6px 14px", fontSize:13, color:"var(--text-secondary)" },
